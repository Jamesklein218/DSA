...
public:
  ...
  ~BinarySearchTree() {
    // You have to delete all Nodes in BinaryTree. However in this task, you can
    // ignore it.
  }
  ...
  string inOrder() { return inOrderRec(this->root); }
  ...
  bool find(T i) { return find(root, i); }
  ...
  T sum(T l, T r) { return sum(root, l, r); }
